...
class Myframe01 extends Frame{
    MenuBar bar;
    Menu
            menu1,menu2,format_menu,font_size,theme;
    MenuItem
            new_item1,item2,item3,item4,item5,item6,i
    tem7,item8;
    MenuItem dracula,queen,dawn,light;
    MenuItem
            size_8,size_12,size_16,size_20,size_24,si
    ze_28;
    TextArea textArea;
    String text;
    ...
    Myframe01(){
        ...
        item8 =new MenuItem("Select
                All",menuShortcut_item8);
                                        ...
                                        ActionListener(){
                                            ...
                                            actionPerformed(ActionEvent event){
                                                FileDialog dialog = new
                                                        FileDialog(new
                                                        Frame(),"Open",FileDialog.LOAD); //this
                                                will load the fileDialog

                                                dialog.setVisible(true);//this will make
                                                dialog visible
                                                String path =
                                                        dialog.getDirectory()+dialog.getFile();
//this will select the path of selected
                                                file and put it into 'path'

                                                setTitle(dialog.getFile()+" -
                                                        CodePad");//this will set Title to
                                                        selected file name and -CodePad
                                                ...
                                                try {
                                                    ...
                                                    textArea.setText(str);//this will display
                                                    text in 'str' in textarea
                                                    fi.close();//this
                                                    will close fi
        ...
        new_item1.addActionListener(new
                                            ActionListener(){
                                                public void
                                                actionPerformed(ActionEvent event) {
                                                    setTitle("Untitled -
        ...
        item6.addActionListener(new
                                        ActionListener(){
                                            ...
                                            actionPerformed(ActionEvent event){
                                                ...
                                                textArea.insert(text,textArea.getCaretPos
                                                        ition());
                                            }
                                        });
        item7.addActionListener(new
                                        ActionListener(){
                                            public void
                                            actionPerformed(ActionEvent event){
                                                text =
